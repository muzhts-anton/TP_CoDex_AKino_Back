...
type PosterClient interface {
	PostComment(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Comment, error)
}
...
func (c *posterClient) PostComment(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Comment, error) {
	out := new(Comment)
	err := c.cc.Invoke(ctx, "/Comm.Poster/PostComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PosterServer interface {
	PostComment(context.Context, *Data) (*Comment, error)
...
func (UnimplementedPosterServer) PostComment(context.Context, *Data) (*Comment, error) {
...
func _Poster_PostComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Data)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PosterServer).PostComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Comm.Poster/PostComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PosterServer).PostComment(ctx, req.(*Data))
	}
...
var Poster_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Comm.Poster",
	HandlerType: (*PosterServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PostComment",
			Handler:    _Poster_PostComment_Handler,
		},
	},
