...
VALUES
    (
        ...
        'Vendetta',
        'Новый боевик с Брюсом Уиллисом!',
        ...
        'https://www.youtube.com/watch?v=xNedngHhP0A',
        '2022-06-12',
        'США',
        'Джаред Кон'
    ),
    (
        ...
        'Одна',
        '-',
        'Одиночество в центре прекрасной природы тайги.',
        ...
        'https://www.youtube.com/watch?v=GY4ditKMaqI',
        '2022-06-09',
        'Россия',
        'Дмитрий Суворов'
    ),
    (
        ...
        '2022-06-15',
        'Ирландия, Великобритания, Польша',
        'Натали Бьянчери'
    ),
    (
        'Northman.webp',
        'Варяг',
        'The Northman',
        'Приключение на севере с новыми лицами Голливуда.',
        ...
        'https://www.youtube.com/watch?v=SSlum8FbX5I',
        '2022-06-10',
        'США',
        'Роберт Эггерс'
    ),
